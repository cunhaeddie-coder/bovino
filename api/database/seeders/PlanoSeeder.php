    ...
    public function run(): void
    {
        ...
        Plano::updateOrCreate(['slug' => 'produtor-premium'], [
            ...
            'recursos'             => [
                ...
                'Ver WhatsApp e telefone de outros usuários',
                'Gestão de rebanho com saúde e pesagens',
        ...
        $eliteRecursos = [
            ...
            'Ver WhatsApp e telefone de outros usuários',
            'Gestão completa: rebanho, reprodução, pasto, curral',
            ...
            'Cotação média por raça/região (30 dias)',
            'Alertas de demanda ilimitados',
            'Prioridade máxima nas buscas',
            'Badge "Elite" no perfil e anúncios',
            'Selo de rastreabilidade (GTA/SISBOV)',
