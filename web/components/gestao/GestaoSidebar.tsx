...
import {
  ...
  X, LogOut, Dna, Store, TrendingUp, Receipt, FileBarChart2, Milk,
  MessageCircle, FileCheck, ShieldCheck, FlaskConical, Salad, ArrowLeftRight, BookOpen, type LucideIcon,
} from "lucide-react";
...
export const NAV_GESTOR: NavItem[] = [
  ...
  { href: "/gestao/nutricional",   label: "Plano Nutricional",Icon: Salad,         color: "text-lime-600"  },
  { href: "/gestao/movimentacoes", label: "Entradas e Saídas",Icon: ArrowLeftRight, color: "text-cyan-600"  },
  ...
  { href: "/ajuda",               label: "Central Ajuda", Icon: BookOpen,        color: "text-blue-600"    },
