...
export default function NovoAnuncioPage() {
  ...
  const totalLote =
    form.preco_unitario && form.quantidade
      ? (parseFloat(form.preco_unitario.replace(",", ".")) * parseInt(form.quantidade || "1")).toLocaleString("pt-BR", { style: "currency", currency: "BRL" })
      : null;
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-1">Preencha os dados do lote que deseja vender.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              maxLength={255}
              placeholder="Ex: 50 bois Nelore para engorda — MT"
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              placeholder="Descreva o estado dos animais, condições de saúde, vacinas, etc."
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => set("idade_meses", e.target.value)}
                placeholder="Ex: 24"
                className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-green-500"
              />
            </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => set("propriedade", e.target.value)}
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-4">
          ...
          <label className="flex items-center gap-3 cursor-pointer select-none">
            <div
              onClick={() => set("aceita_negociacao", !form.aceita_negociacao)}
